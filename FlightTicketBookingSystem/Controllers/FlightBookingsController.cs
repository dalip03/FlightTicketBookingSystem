...
namespace FlightTicketBookingSystem.Controllers
{
    ...
    public class FlightBookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "bid,BCusName,bCusAddress,bCusEmail,bCusSeats,bCusPhoneNum,AdharNumber,ResId")] FlightBooking flightBooking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "bid,BCusName,bCusAddress,bCusEmail,bCusSeats,bCusPhoneNum,AdharNumber,ResId")] FlightBooking flightBooking)
        {
            if (ModelState.IsValid)
            {
